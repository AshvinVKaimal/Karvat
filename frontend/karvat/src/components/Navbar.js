...
const Navbar = () => {
  ...
  return (
    <React.StrictMode>
      <div className="grid grid-cols-9 sm:grid-cols-7 items-center place-items-center bg-krvt_ochre p-1">
        <span className="grid grid-cols-2 items-center place-items-start bg-krvt_ochre p-1">
          <button
        ...
        <div className="col-span-7 sm:col-span-5">
          <a href="/" className="flex items-center justify-center">
            <h1 className="text-white font-karvat text-4xl">Karvat</h1>
          </a>
        </div>

        <span className="grid grid-cols-2 items-center place-items-end bg-krvt_ochre p-1">
        ...
        <div
          className={
            menu
              ? "fixed top-0 left-0 w-2/5 md:w-1/3 lg:w-1/4 xl:w-1/5 2xl:w-1/6 h-screen bg-krvt_brick z-50 duration-500"
              : "fixed top-0 -left-full w-2/5 h-screen bg-krvt_ochre z-50 duration-500"
          }
        >
          <button
            onClick={() => setMenu(!menu)}
