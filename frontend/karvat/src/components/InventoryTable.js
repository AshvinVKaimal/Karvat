...
const InventoryTable = () => {
    ...
    return (
        <React.StrictMode>
            <div>
                <br />
                <h2 className="font-karvat text-2xl relative left-2 bottom-1">Current Inventory</h2>
                <table className="font-body text-lg border-collapse border border-gray-400 w-1/2">
                    <thead>
                        <tr className="bg-krvt_mahogany text-white">
                ...
                <br />
                <h2 className="font-karvat text-2xl relative left-2 bottom-1">Product Sales</h2>
                <table className="font-body text-lg border-collapse border border-gray-400 w-1/2">
                    <thead>
                        <tr className="bg-krvt_mahogany text-white">
                            <th className="border p-3 border-solid border-[#ddd] text-left">Product Name</th>
