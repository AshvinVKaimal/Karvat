    ...
    <React.StrictMode>
      <div className='bg-krvt_cream h-full min-h-screen'>
        ...
        <div className='max-w-lg mx-auto'>
          ...
          <h1 className='flex text-krvt_brick font-karvat text-6xl mt-5 justify-center text-center'>Markets</h1>
          <p className='flex text-krvt_moss font-body text-xl mb-5 justify-center text-center'>Browse through some of the most famous local markets of India,<br></br>each offering their own unique items and experiences</p>
        </div>
