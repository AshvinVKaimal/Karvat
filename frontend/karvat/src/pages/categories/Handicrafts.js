    ...
    <React.StrictMode>
      <div className='bg-krvt_cream h-full min-h-screen'>
        ...
        <div className='max-w-lg mx-auto'>
          ...
          <h1 className='flex text-krvt_brick font-karvat text-6xl mt-5 justify-center text-center'>Handicrafts</h1>
          <div className='flex justify-center p-3'>
            <img src={img} className='h-52'></img>
          </div>
          <p className='flex text-krvt_moss font-body text-xl mb-5 justify-center text-center'>Browse through some of the most famous local markets of India<br></br>to find all kinds of traditional Indian handicrafts</p>
        </div>
        ...
        <div className='max-w-xl md:max-w-2xl lg:max-w-4xl xl:max-w-6xl mx-auto'>
          <div className='grid grid-cols-6 gap-8 mt-5'>
            <a href='/markets/chandni_chowk' className='col-span-6 sm:col-span-3'>
              <div className='group flex relative bg-krvt_brick p-5 rounded-2xl'>
                <div className='text-white text-left z-10'>
                    <h2 className='font-karvat text-4xl sm:text-3xl'>Chandni Chowk</h2>
                    <h4 className='relative bottom-2 font-karvat text-2xl sm:text-xl'>Delhi</h4>
            ...
            <a href='/markets/pinkcity_bazaar' className='col-span-6 sm:col-span-3'>
              <div className='group flex relative bg-krvt_brick p-5 rounded-2xl'>
                <div className='text-white text-left z-10'>
                    <h2 className='font-karvat text-4xl sm:text-3xl'>Pink City Bazaars</h2>
                    <h4 className='relative bottom-2 font-karvat text-2xl sm:text-xl'>Jaipur</h4>
            ...
            <a href='/markets/laad_bazaar' className='col-span-6 sm:col-span-3'>
              <div className='group flex relative bg-krvt_brick p-5 rounded-2xl'>
                <div className='text-white text-left z-10'>
                    <h2 className='font-karvat text-4xl sm:text-3xl'>Laad Bazaar</h2>
                    <h4 className='relative bottom-2 font-karvat text-2xl sm:text-xl'>Hyderabad</h4>
            ...
            <a href='/markets/devaraja_market' className='col-span-6 sm:col-span-3'>
              <div className='group flex relative bg-krvt_brick p-5 rounded-2xl'>
                <div className='text-white text-left z-10'>
                    <h2 className='font-karvat text-4xl sm:text-3xl'>Devaraja Market</h2>
                    <h4 className='relative bottom-2 font-karvat text-2xl sm:text-xl'>Mysore</h4>
            ...
            <a href='/markets/colaba_causeway' className='col-span-6 sm:col-span-3'>
              <div className='group flex relative bg-krvt_brick p-5 rounded-2xl'>
                <div className='text-white text-left z-10'>
                    <h2 className='font-karvat text-4xl sm:text-3xl'>Colaba Causeway</h2>
                    <h4 className='relative bottom-2 font-karvat text-2xl sm:text-xl'>Mumbai</h4>
            ...
            <a href='/markets/commercial_street' className='col-span-6 sm:col-span-3'>
              <div className='group flex relative bg-krvt_brick p-5 rounded-2xl'>
                <div className='text-white text-left z-10'>
                    <h2 className='font-karvat text-4xl sm:text-3xl'>Commercial Street</h2>
                    <h4 className='relative bottom-2 font-karvat text-2xl sm:text-xl'>Bengaluru</h4>
